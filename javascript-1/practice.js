...
var me = {
	...
	greeter: function(firstName, state){
		return 'My name is ' + firstName + 'and I live in ' + state;
	}
}
...
function bigOrSmall(arr) {
 let answers = []; {
 	 for(var i = 0; 100 < bigOrSmall.length; i++);
		 answers.push(big);
		}
 }
...
//Using a for loop, loop over the passed in array IN REVERSE (this means your counter should decrement), and then add each item to the 'reversed' array variable you created. 
...
// let doubled = array1.map[function() {
// 	return array1 * 2;
// }];
...
// let filterArray = [109, 208, 308, 408, 508, 608]

// let filtered = filteredArray.filter(function(val){
//   if(val < 100){
// retrun true;
//   } else {
//     return false;
...
// Code Here
// let forTheLoveOfGeorge = notGeorge(Function(arr) {
...
// Code Here
// let enemies = people.map(function(peopleObj, i){
//     let objCopy = {...peopleObj};
//     objCopy.id = i + 1;
//     return objCopy;
//   })
//   console.log(enemies);
